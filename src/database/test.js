...
Database.then(async db => {
    ...
    //inserir dados na tabela
     await saveOrphanage(db, {
        ...
        lat: "-3.0931911",
        lng: "-60.0651001",
        name: "Lar das MeninOs",//  about: "Presta assistência a crianças de 06 a 15 anos que se encontre em situação //de risco e/ou vulnerabilidade social.",
        whatsapp: "9384983784273",
        images: [
